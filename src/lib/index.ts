...
export const clickAdslink =
	'https://www.profitablegatecpm.com/ifg6repz?key=b1132a822575e4aa56d8006e4ccf8f32';
export const domainMovies = 'https://vidsrc.me';
export const tmdbEndpoint = 'https://api.themoviedb.org/3';
export const DOMAIN_KKPHIM = 'https://phimapi.com';
// export const DOMAIN_KKPHIM_IMAGE = 'https://wsrv.nl/?url=https://img.phimapi.com';
export const DOMAIN_KKPHIM_IMAGE = 'https://pbimgsvr.b-cdn.net';
// export const DOMAIN_TMDB_IMAGE_ORIGINAL = 'https://wsrv.nl/?url=https://image.tmdb.org/t/p/original';
export const DOMAIN_TMDB_IMAGE_ORIGINAL = 'https://pbtmdbsvr.b-cdn.net/t/p/original';
// export const DOMAIN_TMDB_IMAGE_CDN = 'https://wsrv.nl/?url=https://image.tmdb.org';
export const DOMAIN_TMDB_IMAGE_CDN = 'https://pbtmdbsvr.b-cdn.net';
// export const tmdbImageUrl = 'https://wsrv.nl/?url=https://image.tmdb.org/t/p/w300';
export const tmdbImageUrl = 'https://pbtmdbsvr.b-cdn.net/t/p/w300';
export const SUPABASE_URL =
	(typeof process !== 'undefined' && process.env?.SUPABASE_URL) ||
	'https://nhxgdsanykpnmghtohfz.supabase.co';
...
export const patternKKImageDomain = /https:\/\/img\.phimapi\.com|https:\/\/phimimg\.com/g;
export const getKKImageUrl = (path: string) => {
	if (!path) return '';
	if (path.startsWith('http://') || path.startsWith('https://')) {
		return path.replace(patternKKImageDomain, DOMAIN_KKPHIM_IMAGE);
	}
	return `${DOMAIN_KKPHIM_IMAGE}/${path}`;
};
import { browser } from '$app/environment';

export const getTmdbUrl = (path: string) => {
	let cleanPath = path;
	if (path.startsWith('http://') || path.startsWith('https://')) {
		try {
...
export const tmdbOptionApi = {
	method: 'GET',
	headers: {
		accept: 'application/json'
	}
};
export const tmdbMoviesGenres = {
	genres: [
		{
			id: 28,
			name: 'Phim Hành Động'
...
export const tmdbMoviesGenresEnglish = {
  genres: [
    { id: 28,     name: 'Action' },
...
export const kkMovieGenresEnglish = [
  { _id: '9822be111d2ccc29c7172c78b8af8ff5', name: 'Action',            slug: 'hanh-dong' },
  { _id: 'bb2b4b030608ca5984c8dd0770f5b40b', name: 'Romance',           slug: 'tinh-cam' },
  { _id: 'ba6fd52e5a3aca80eaaf1a3b50a182db', name: 'Comedy',            slug: 'hai-huoc' },
  { _id: '3a17c7283b71fa84e5a8d76fb790ed3e', name: 'Historical',        slug: 'co-trang' },
  { _id: 'a7b065b92ad356387ef2e075dee66529', name: 'Drama / Psychological', slug: 'tam-ly' },
  { _id: '7a035ac0b37f5854f0f6979260899c90', name: 'Crime',             slug: 'hinh-su' },
  { _id: '1bae5183d681b7649f9bf349177f7123', name: 'War',               slug: 'chien-tranh' },
  { _id: '591bbb2abfe03f5aa13c08f16dfb69a2', name: 'Sports',            slug: 'the-thao' },
  { _id: '578f80eb493b08d175c7a0c29687cbdf', name: 'Martial Arts',      slug: 'vo-thuat' },
  { _id: '68564911f00849030f9c9c144ea1b931', name: 'Sci-Fi',            slug: 'vien-tuong' },
  { _id: '66c78b23908113d478d8d85390a244b4', name: 'Adventure',         slug: 'phieu-luu' },
  { _id: '0bcf4077916678de9b48c89221fcf8ae', name: 'Science',           slug: 'khoa-hoc' },
  { _id: '4db8d7d4b9873981e3eeb76d02997d58', name: 'Horror',            slug: 'kinh-di' },
  { _id: '252e74b4c832ddb4233d7499f5ed122e', name: 'Music',             slug: 'am-nhac' },
  { _id: '2276b29204c46f75064735477890afd6', name: 'Mythology',         slug: 'than-thoai' },
  { _id: '1645fa23fa33651cef84428b0dcc2130', name: 'Documentary',       slug: 'tai-lieu' },
  { _id: 'a2492d6cbc4d58f115406ca14e5ec7b6', name: 'Family',            slug: 'gia-dinh' },
  { _id: '37a7b38b6184a5ebd3c43015aa20709d', name: 'Drama',             slug: 'chinh-kich' },
  { _id: '2fb53017b3be83cd754a08adab3e916c', name: 'Mystery',           slug: 'bi-an' },
  { _id: '01c8abbb7796a1cf1989616ca5c175e6', name: 'School / Teen',     slug: 'hoc-duong' },
  { _id: '268385d0de78827ff7bb25c35036ee2a', name: 'Classic',           slug: 'kinh-dien' },
  { _id: '4b4457a1af8554c282dc8ac41fd7b4a1', name: 'Adult (18+)',       slug: 'phim-18' }
];
...
export const BUNNY_VIDEO_CDN_DOMAIN = 'opstream.b-cdn.net';

export function getProxyStreamUrl(originalUrl: string): string {
	if (!originalUrl) return '';
	try {
		const url = new URL(originalUrl);
		// Không proxy nếu URL đã là Bunny CDN của chúng ta
		if (url.host === BUNNY_VIDEO_CDN_DOMAIN) {
			return originalUrl;
		}
		// Rewrite sang format: https://{BUNNY_VIDEO_CDN_DOMAIN}/hls/{original_host}/{pathname}{search}
		return `https://${BUNNY_VIDEO_CDN_DOMAIN}/hls/${url.host}${url.pathname}${url.search}`;
	} catch (e) {
		console.error('Lỗi định dạng link stream:', originalUrl);
		return originalUrl;
	}
}

export * from './utils/opener';

// fetch('https://api.themoviedb.org/3/discover/movie?include_adult=true&include_video=true&language=vi-VN&page=1&primary_release_year=2020&release_date.gte=1900-12-31&release_date.lte=2000-12-31&sort_by=popularity.desc&with_crew=59', options)
// fetch('https://api.themoviedb.org/3/discover/movie?include_adult=true&include_video=true&language=vi-VN&page=1&release_date.gte=2020-12-31&sort_by=popularity.desc&with_origin_country=VN', options)
