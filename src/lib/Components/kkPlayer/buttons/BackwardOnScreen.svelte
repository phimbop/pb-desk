...
<div
	class="flex items-center justify-center z-40 p-2 md:p-3 {props.class} animate-bezel-hide bg-slate-500/50 rounded-full opacity-0"
>
<svg class="text-white w-6 h-6 md:w-10 md:h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
