...
*/
export function process_movies() {
    const ret = wasm.process_movies();
...
/**
* @param {any} some_iterable
* @returns {string}
*/
export function generate_xml_slugs(some_iterable) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.generate_xml_slugs(retptr, addBorrowedObject(some_iterable));
...
export function __wbg_join_1d35973de7cb22d9(arg0, arg1, arg2) {
